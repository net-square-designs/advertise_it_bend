...
//    * @returns {Promise<AppResponse>} The Return Object
//    */
//   static async requestToBecomeAPromoter(req, res) {
...
//        * @type {{status: string}}
//        */
//       const request = await PromoterRequestRepo.getByUserId(userId);
...
//       await PromoterRequestRepo.create({ ...req.body, userId });
